...
Raw target values and secrets are excluded. Structured redaction reports field paths, secret classes and value digests without exposing values. Artifact hashes prove identity, not truth or security impact. A separate verifier result determines whether evidence supports a candidate.
